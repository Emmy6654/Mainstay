...
### Added
- Formal mentorship agreements with queryable apprenticeship state and audit events; safety incident reporting and resolution; regional on-call schedules; and availability-checked engineer workload assignments.
